...
import { addProduct, deleteProductById, fetchProductById, fetchProducts, searchProducts, undeleteProductById, updateProductById } from "./ProductApi";
...
export const searchProductsAsync = createAsyncThunk("products/searchProductsAsync", async (searchQuery) => {
...
export const selectSearchResults = (state) => state.ProductSlice.searchResults
export const selectProductSearchStatus = (state) => state.ProductSlice.productSearchStatus
